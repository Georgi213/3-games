...
namespace RegistrationAndLogin
{
    public partial class PictureView : Form
    {
        ...
        public PictureView()
        {
            ...
            Button clearimg = new Button { Text = "Tühjenda pilt", AutoSize = true, Name = "nupp2" };
            Button background = new Button { Text = "Määrake taustavärv", AutoSize = true, Name = "nupp3" };
            Button close = new Button { Text = "Sulge", AutoSize = true, Name = "nupp4" };
